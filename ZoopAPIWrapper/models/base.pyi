...
class ZoopObject:
    ...
    @staticmethod
    def make_data_copy_with_kwargs(data: Dict[str, Any], **kwargs) -> Dict[str, Any]: ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], allow_empty: bool=..., **kwargs: Any) -> ZoopObject: ...
    @classmethod
    def from_dict_or_instance(cls, data: Union[Dict[str, Any], ZoopObject], allow_empty: bool=..., **kwargs: Any) -> ZoopObject: ...
...
class BusinessOrIndividualModel(MarketPlaceModel):
    ...
    def set_identifier(self, taxpayer_id: Optional[str] = ..., ein: Optional[str] = ...) -> None: ...
    def get_validation_fields(self) -> set: ...
    def get_all_fields(self) -> set: ...
    @classmethod
