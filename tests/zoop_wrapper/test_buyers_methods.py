...
class ZoopWrapperBuyerMethodsTestCase(TestCase):
    ...
    def test_remove_buyer(self, mocked_delete):
        """
        Test remove_buyer method.
        Got the buyer id from buyers dump.
        ...
        mocked_delete.return_value = MagicMock(
            status_code=200,
            json=MagicMock(
                return_value={'id': 'a12c6bf830854b5d9c1d2d36cb1478a0', 'resource': 'buyer', 'deleted': True}
            )
        )
